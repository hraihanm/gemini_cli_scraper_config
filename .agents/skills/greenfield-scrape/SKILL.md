...
description: "Greenfield Phase 1 discovery — schema from this message prose. Usage: /greenfield-scrape url=<url> name=<slug> [out=<dir>] [auto_next=true] [spec=<path>] — field list in free text below."
---
